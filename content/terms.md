...
The Site is intended for adults aged 18 and over who are considering the use of an AI bookkeeping product for a business purpose. By using the Site, you represent that you are at least 18 years old.

The Site is directed at users in Australia. We make no representation that the content or any future product complies with the laws of any jurisdiction outside Australia. If you access the Site from outside Australia, you do so at your own risk and are responsible for compliance with local laws.

---

## 3. Waitlist and Survey

When you submit the waitlist survey, you agree to:

- Provide accurate and complete information
- Not submit another person's personal details without their knowledge and consent
- Not use automated tools, bots, or scripts to submit the form

We use the information you provide solely for the purposes described in our Privacy Policy. Joining the waitlist does not create any contractual obligation on either party. We reserve the right to close, pause, or restructure the waitlist at any time without notice.

---

## 4. Intellectual Property

All content on the Site — including text, graphics, the Finwell AI name, logo, and product descriptions — is owned by or licensed to Finwell AI and is protected by Australian copyright law and applicable intellectual property laws.

You may view and print pages from the Site for your own personal, non-commercial reference. You may not copy, reproduce, republish, adapt, distribute, or create derivative works from any content on the Site without our prior written consent.

Nothing in these Terms grants you any licence to use the Finwell AI name, logo, or other trade marks.
...
- Interferes with the operation of the Site or the servers that host it
- Attempts to gain unauthorised access to any part of the Site or its infrastructure
- Harasses, abuses, or harms any other person

We reserve the right to restrict or terminate access to the Site for any person who breaches these Terms.

---

## 6. Third-Party Links and Services

The Site may contain links to third-party websites or reference third-party tools and services. These links are provided for convenience only. We do not endorse, control, or take responsibility for the content, privacy practices, or availability of any third-party site.
...
The Site and its content are provided on an "as is" basis. To the maximum extent permitted by law, we exclude all warranties, representations, and conditions — express or implied — relating to the Site, its content, or any future product.
...
Nothing on the Site constitutes financial, accounting, legal, or tax advice. The product is under development and all descriptions of features, pricing, and availability are indicative only.
...
Our collection and handling of your personal information is governed by our [Privacy Policy](/privacy), which forms part of these Terms. By using the Site, you agree to our Privacy Policy.
...
We may update these Terms from time to time. The "Last updated" date at the top of this page will reflect any changes. Continued use of the Site after changes are posted constitutes your acceptance of the updated Terms. If a change is material, we will make reasonable efforts to notify waitlist members by email before the change takes effect.
